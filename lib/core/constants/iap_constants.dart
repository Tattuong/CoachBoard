class IapConstants {
  ...
  static const String productPrefix = 'cb';

  static const String remoteConfigUrl = 'https://api2.blwsmartware.net/N249.json';
  ...
  static const String removeAdsProductId = 'cb_remove_ads';
