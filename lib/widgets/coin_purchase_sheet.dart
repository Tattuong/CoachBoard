                ...
                children: [
                  Expanded(
                    child: Text(
                      ...
                      style: AppTypography.titleLarge(color: AppColors.ink(context)).copyWith(fontSize: 20),
                    ),
                  ),
                  IconButton(
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(color: AppColors.brand(context).withValues(alpha: 0.28), blurRadius: 16, offset: const Offset(0, 6)),
        ],
      ),
      child: Column(
                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          Text('coins', style: TextStyle(color: AppColors.muted(context), fontSize: 13)),
                          const Spacer(),
                          if (isHotDeal) _PackBadge(label: AppStrings.t(context, 'hotDealBadge'), color: AppColors.coin),
                          if (isBestValue) ...[
                            if (isHotDeal) const SizedBox(width: 4),
                            _PackBadge(label: AppStrings.t(context, 'bestValueBadge'), color: AppColors.brand(context)),
                          ],
                        ],
                      ),
                      ...
                      Text(
                        ...
                        style: TextStyle(
                          color: bonus > 0 ? AppColors.success : AppColors.muted(context),
                          fontSize: 12,
...
class _EmptyBillingState extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        children: [
          Icon(Icons.storefront_outlined, size: 36, color: AppColors.muted(context).withValues(alpha: 0.7)),
          const SizedBox(height: 10),
          Text(
            text,
            textAlign: TextAlign.center,
            style: TextStyle(color: AppColors.muted(context), fontSize: 14, height: 1.4),
          ),
        ],
      ),
    );
...
class _EarnHintRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Row(
        children: [
          Icon(Icons.lightbulb_outline_rounded, size: 16, color: AppColors.muted(context)),
          const SizedBox(width: 8),
          Expanded(
            child: Text(text, style: TextStyle(color: AppColors.muted(context), fontSize: 11, height: 1.35)),
          ),
        ],
      ),
    );
